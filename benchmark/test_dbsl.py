...
import json
import os
from DBpediaSpotlight import DBpedia_Spotlight
...
class test_dbsl():
	...
	def run_dbsl_in_batch(self, output_file_path):
		...
		for i in range(len(self.testing_sentences)):
			...
			annotation_list = dbsl.candidates(testing_sent, surface_form)
...
if __name__ == "__main__":
	test_case = test_dbsl()
	# test_case.run_dbsl_in_batch(os.path.join(CURRENT_DIR_PATH, 
	# 								"dbpediaspotlight",
